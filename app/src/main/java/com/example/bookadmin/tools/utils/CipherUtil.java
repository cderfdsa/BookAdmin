...
//            }
    ...
    public static String getAESInfoError(String info) {
        byte[] iv = new byte[16];
        ...
        try {
            ...
            enData = CipherUtil.encryptAES(info.getBytes("utf-8"), pwdByte, iv);
    ...
    //61687284F2889303F99A146CD1723F4DCC    1
    //A0449161992A298660B836B4F8344F4C7A    2
    //A9B5C165382BDDC4BA3583ADAC3FCBD708    1
    ...
    public static String byte2hex(byte[] data) {
        if (data == null) {
            ...
            String str = encodeHexString(data).toUpperCase();//097F95B417FC00DF16895C48D5E2B361 0F39DFD1C6AFA86EDB193472E1B0675E
            return str;
        }
    }
...
//        keygen.init(128, new SecureRandom(datas));
