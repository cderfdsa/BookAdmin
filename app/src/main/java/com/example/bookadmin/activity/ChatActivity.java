...
import com.example.bookadmin.im.chat.ChatPresenter;
import com.example.bookadmin.im.mm.CustomMessage;
import com.example.bookadmin.im.mm.FileMessage;
import com.example.bookadmin.im.mm.ImageMessage;
import com.example.bookadmin.im.mm.Message;
import com.example.bookadmin.im.chat.RefreshEvent;
import com.example.bookadmin.im.mm.MessageFactory;
import com.example.bookadmin.im.group.GroupInfo;
import com.example.bookadmin.im.mm.TextMessage;
import com.example.bookadmin.im.mm.VideoMessage;
import com.example.bookadmin.im.mm.VoiceMessage;
import com.example.bookadmin.tools.utils.MediaUtil;
import com.example.bookadmin.tools.utils.RecorderUtil;
...
import com.tencent.qcloud.ui.viewfeatures.ChatView;
...
public class ChatActivity extends IMBaseActivity implements ChatView, View.OnTouchListener, AbsListView.OnScrollListener {
    ...
    public void sendPhoto() {
        ...
        if (intent_photo.resolveActivity(getPackageManager()) != null) {
            File tempFile = SDCardUtils.getTempFile(SDCardUtils.FileType.IMG);
            if (tempFile != null) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK && data != null) {
                showImagePreview(SDCardUtils.getFilePath(this, data.getData()));
            }

        } else if (requestCode == FILE_CODE) {
            if (resultCode == RESULT_OK) {
                sendFile(SDCardUtils.getFilePath(this, data.getData()));
            }
