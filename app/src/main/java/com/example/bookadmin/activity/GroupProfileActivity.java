...
import com.example.bookadmin.im.group.GroupInfoPresenter;
import com.example.bookadmin.im.group.GroupInfoView;
...
public class GroupProfileActivity extends IMBaseActivity implements GroupInfoView, View.OnClickListener {
            ...
            case R.id.btnDel:
                if (isGroupOwner){
                    GroupManagerPresenter.dismissGroup(identify, new TIMCallBack() {
                        ...
                        public void onError(int i, String s) {
                            ...
                            if (i == 10004 && type.equals(GroupInfo.privateGroup)){
                                Toast.makeText(GroupProfileActivity.this, "讨论群不能解散",Toast.LENGTH_SHORT).show();
                            }
                        }

                        @Override
                        public void onSuccess() {
                            Toast.makeText(GroupProfileActivity.this, "解散群成功",Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                }else{
                    GroupManagerPresenter.quitGroup(identify, new TIMCallBack() {
                        ...
                        @Override
                        public void onSuccess() {
                            Toast.makeText(GroupProfileActivity.this, "推出群成功",Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                }
                ...
                new ListPickerDialog().show(stringList,getSupportFragmentManager(), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, final int which) {
                        ...
                        TIMGroupManagerExt.getInstance().modifyGroupInfo(param, new TIMCallBack() {
                            @Override
                            public void onError(int i, String s) {
                                Toast.makeText(GroupProfileActivity.this, "修改失败",Toast.LENGTH_SHORT).show();
                            }
...
//                    @Override
//                    public void onClick(View v) {
//                        EditActivity.navToEdit(GroupProfileActivity.this, "修改成功", info.getGroupName(), REQ_CHANGE_NAME, new EditActivity.EditInterface() {
//                            @Override
